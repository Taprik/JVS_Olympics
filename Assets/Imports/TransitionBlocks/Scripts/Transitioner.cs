...
public class Transitioner : MonoBehaviour
{
    ...
    [Tooltip("If true this transitioner will   launch the anim at Start of Scene")]
    ...
    {
        yield return StartCoroutine(ActualTransitionOut());
    ...
    public void TransitionOutWithoutChangingScene()
    {
        if (_canTransition)
        {
            StartCoroutine(ActualTransitionOut());
        }
    }
    ...
    private IEnumerator ActualTransitionOut()
    {
