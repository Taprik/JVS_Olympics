...
namespace Tir
{
    public class Tir_ScoreManager : MonoBehaviour
    {
        ...
        private void InitTeam()
        {
            ...
            {
                if (PlayerPrefs.HasKey(Tir_GeneralVariables.PlayerNameKey + (team.Id + 1).ToString()))
                    team.Name = PlayerPrefs.GetString(Tir_GeneralVariables.PlayerNameKey + (team.Id + 1).ToString());
                team.UpdateNameAndScore();
        ...
        private void SaveWinnerScore()
        {
            ...
            PlayerPrefs.SetFloat(Tir_GeneralVariables.WinnerScoreKey, team.Score);
        }
